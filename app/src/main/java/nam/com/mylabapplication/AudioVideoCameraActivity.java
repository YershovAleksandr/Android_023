...
public class AudioVideoCameraActivity extends AppCompatActivity {

	private static final int PREVIEW_PAUSE = 2000;
	private static final String TAG = "AudioVideoCamera";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.audiovideocamera);
