...
public class IndicateTouchLocationActivity extends AppCompatActivity {
	...
	protected static final String TAG = "IndicateTouch";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.touchindicatetouchlocation);
