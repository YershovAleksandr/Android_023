...
public class AudioRecordingActivity extends AppCompatActivity {
	...
	private static final String mFileName = Environment.getExternalStorageDirectory().getAbsolutePath() + "/audiorecordtest.3gp";
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.audiovideoaudiorecording);
